...
  // 🔥 MAIN UPLOAD FUNCTION (Folder + Split + Notebook)
...
      
      // We need the FINAL VIEW LINK for the Notebook
      const notebookLink = await new Promise<string>((resolve) => {
          const xhr = new XMLHttpRequest();
